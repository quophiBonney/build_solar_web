        ...
        <div className="row justify-content-center">
          <div className="col-sm-12 col-md-12 col-lg-7 mt-5">
            <div className="px-4 mt-5">
              <h2 className="mb-5">Single-payment solar lease</h2>
              <img
                src="https://cdn-assets-us.frontify.com/s3/frontify-enterprise-files-us/eyJwYXRoIjoic3VucnVuXC9maWxlXC9YVFhSZm5yZ2JRMlJqTXMxV01NOS5qcGcifQ:sunrun:5PlOrKo3eKg2DhKtEVWLyC6pPIpbhrqvWfcE_9XZn3w?width=1440"
                alt="car image"
                className="img-fluid"
              />
              <ul
