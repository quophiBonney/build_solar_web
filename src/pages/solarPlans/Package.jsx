...
const Package = () => {
  return (
    <div>
      <div className="container-fluid mt-5 package-background">
        <div className="container">
          <div className="row justify-content-center">
            ...
            <div className="col-sm-12 col-md-12 col-lg-4">
              <div className="card px-4 package-card mb-5">
                <div
                  className="mt-5 mb-5"
                ...
                >
                  ...
                  <small className="fw-bold mb-3">
                    ...
                    providing clean, affordable, resilient energy for as little
                    as $0 down. You’ll only be responsible for paying a low
                    monthly bill or pay the lease up-front.
                  </small>
                  <ul
                    style={{
                      listStyle: "none",
            ...
            <div className="col-sm-12 col-md-12 col-lg-4">
              <div className="card px-4 mb-5">
                ...
                >
                  <h5>Loan</h5>
                  <small className="fw-bold mb-3">
                    Build solar's monthly loan gives you the benefits of owning
                    your solar energy system through fixed monthly payments at a
                    competitive rate.
                  </small>
                  <ul
                    style={{
